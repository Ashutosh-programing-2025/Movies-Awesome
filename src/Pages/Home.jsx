          ...
          {data1?.map((e) => {
            return (
              <NavLink key={e.id} to={`/${e.id}`}>
                <div className="flex flex-col h-96 w-64 items-center overflow-hidden bg-custom-header-bg rounded-md hover:overflow-hidden hover:absolute duration-300 gap-2 max-[607px]:w-full p-3 justify-center shadow-xl shadow-red-600">
                  <img
